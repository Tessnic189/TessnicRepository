...
const drivers = [
    { seniority: 1, name: 'Jewell, Keith', routeId: '32D', working: 'Unconfirmed', notes: '' },
    { seniority: 2, name: 'Landis, Matt', routeId: '35B', working: 'Unconfirmed', notes: '' },
    { seniority: 3, name: 'Erickson, Tony', routeId: '32C', working: 'Unconfirmed', notes: '' },
    { seniority: 4, name: 'Bromaghin, Roy', routeId: '30B', working: 'Unconfirmed', notes: '' },
    { seniority: 5, name: 'Spencer, Pat', routeId: '34A', working: 'Unconfirmed', notes: '' },
    { seniority: 6, name: 'Olafson, Andy', routeId: '33A', working: 'Unconfirmed', notes: '' },
    { seniority: 7, name: 'Stebe, Mike', routeId: '32E', working: 'Unconfirmed', notes: '' },
    { seniority: 8, name: 'Beam, David', routeId: '30A', working: 'Unconfirmed', notes: '' },
    { seniority: 9, name: 'Foss, Naomi', routeId: '32I', working: 'Unconfirmed', notes: '' },
    { seniority: 10, name: 'Wiegman, Nate', routeId: '31A', working: 'Unconfirmed', notes: '' },
    { seniority: 11, name: 'Haaland, Gabriel', routeId: '33E', working: 'Unconfirmed', notes: '' },
    { seniority: 12, name: 'Peterson, Doug', routeId: '35C', working: 'Unconfirmed', notes: '' },
    { seniority: 13, name: 'Doughtery, Jaime', routeId: '31D', working: 'Unconfirmed', notes: '' },
    { seniority: 14, name: 'Evan Hanks', routeId: '32A', working: 'Unconfirmed', notes: '' },
    { seniority: 15, name: 'Quance, Doug', routeId: '33D', working: 'Unconfirmed', notes: '' },
    { seniority: 16, name: 'Pendleton, Tyler', routeId: 'Unassigned', working: 'Unconfirmed', notes: '' },
    { seniority: 17, name: 'Carlson, Sam', routeId: 'Unassigned', working: 'Unconfirmed', notes: '' },
    { seniority: 18, name: 'Christenson, Brad', routeId: 'Unassigned', working: 'Unconfirmed', notes: '' },
    { seniority: 19, name: 'Elting, Jamie', routeId: '30C', working: 'Unconfirmed', notes: '' },
    { seniority: 20, name: 'Neustel, Kory', routeId: 'Unassigned', working: 'Unconfirmed', notes: '' },
    { seniority: 21, name: 'Stevens, Derek', routeId: 'Unassigned', working: 'Unconfirmed', notes: '' },
    { seniority: 22, name: 'Prokott, Josh', routeId: 'Unassigned', working: 'Unconfirmed', notes: '' },
    { seniority: 23, name: 'Peterson, James', routeId: '35A', working: 'Unconfirmed', notes: '' },
    { seniority: 24, name: 'McCormick, Mike', routeId: '33B', working: 'Unconfirmed', notes: '' },
    { seniority: 25, name: 'Shaw, Justin', routeId: '33C', working: 'Unconfirmed', notes: '' },
    { seniority: 26, name: 'Glassman, Joe', routeId: '31F', working: 'Unconfirmed', notes: '' },
    { seniority: 27, name: 'Kaiser, Matt', routeId: '32B', working: 'Unconfirmed', notes: '' },
    { seniority: 28, name: 'Oelke, Logan', routeId: '34B', working: 'Unconfirmed', notes: '' },
    { seniority: 29, name: 'Haack, Cory', routeId: 'Unassigned', working: 'Unconfirmed', notes: '' },
    { seniority: 30, name: 'Roger, Luke', routeId: 'Unassigned', working: 'Unconfirmed', notes: '' },
    { seniority: 31, name: 'Chase Rivera', routeId: '31B', working: 'Unconfirmed', notes: '' },
    { seniority: 32, name: 'Mike Vojak', routeId: 'Unassigned', working: 'Unconfirmed', notes: '' },
    { seniority: 33, name: 'Parsons, Jacob', routeId: '31C', working: 'Unconfirmed', notes: '' },
    { seniority: 34, name: 'Paggen, Brody', routeId: 'Unassigned', working: 'Unconfirmed', notes: '' },
    { seniority: 35, name: 'Johannsen, Wyatt', routeId: 'Unassigned', working: 'Unconfirmed', notes: '' },
    { seniority: 36, name: 'Dickenson, John', routeId: 'Unassigned', working: 'Unconfirmed', notes: '' }
];
...
function changeWorkingStatus(driverIndex, status) {
    const currentDriver = drivers[driverIndex];
    const routeReference = driverRouteReference.find(ref => ref.name === currentDriver.name);

    if (status === 'Going Home') {
        unassignRoute(driverIndex);
    } else if (currentDriver.working === 'Going Home' && (status === 'Unconfirmed' || status === 'Yes' || status === 'Maybe') && routeReference) {
    ...
    drivers[driverIndex].working = status;
    populateDriverTable();
...
function updateExtrasCount() {
    const unconfirmedDrivers = drivers.filter(driver => ['Unconfirmed', 'Yes', 'Maybe'].includes(driver.working)).length;
...
function populateDriverTable() {
    ...
    drivers.forEach((driver, index) => {
        ...
        row.style.backgroundColor = getRowColor(driver.working); // Set row color based on working status
        row.innerHTML = `
        ...
        buttonContainer.appendChild(createButton('Unconfirmed', 'white', () => changeWorkingStatus(index, 'Unconfirmed')));
        buttonContainer.appendChild(createButton('Going Home', 'lightblue', () => changeWorkingStatus(index, 'Going Home')));
        buttonContainer.appendChild(createButton('Yes', 'lightgreen', () => changeWorkingStatus(index, 'Yes')));
        buttonContainer.appendChild(createButton('Maybe', '#FFD700', () => changeWorkingStatus(index, 'Maybe')));
...
function addDriver() {
    ...
    const working = document.getElementById('driver-working').value;
    ...
    if (name && seniority) {
        const newDriver = { seniority, name, routeId, working, notes };
        ...
        document.getElementById('driver-working').value = 'Unconfirmed';
            ...
            <td>
                ...
                ` : `
                    <select onchange="assignDriver(${routeIndex}, this.value)">
                        ...
                        ${drivers.filter(driver => driver.routeId === 'Unassigned' && driver.working !== 'Going Home').map(driver => `<option value="${driver.name}">${driver.name}</option>`).join('')}
                    </select>
                `}
            </td>
            <td>
...
function populateUnassignedDriverList() {
    ...
    drivers
        .filter(driver => driver.routeId === 'Unassigned' && driver.working !== 'Going Home')
        .forEach(driver => {
...
function setDriverWorking(driverName) {
    const driverIndex = drivers.findIndex(driver => driver.name === driverName);
    if (driverIndex !== -1) {
        drivers[driverIndex].working = 'Going Home';
